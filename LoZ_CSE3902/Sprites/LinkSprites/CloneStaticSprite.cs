...
{
    public class CloneStaticSprite : ISprite
    {
        ...
        public CloneStaticSprite(Texture2D spriteSheet, Rectangle stepFrameSize, int frameCount)
        {
            texture = spriteSheet;
        ...
        {
            GameUtility.Instance.SpriteBatch.Draw(texture, destinationVector, frameRectangle, Color.Gray);
        }
        public void Draw(Vector2 destinationVector, bool goNextFrame)
        {
            ...
            GameUtility.Instance.SpriteBatch.Draw(texture, destinationVector, frame[frame_number], Color.Gray);
        }
