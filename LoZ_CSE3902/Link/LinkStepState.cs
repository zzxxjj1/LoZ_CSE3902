...
{
    public class LinkStepState : ILinkState
    {
        ...
        public LinkStepState(LinkPlayer player)
        {
            this.player = player;
        ...
        private void SetSprite(Direction direction)
        {
            ...
            {
                case (Direction.Down):
                    sprite = LinkSpriteFactory.Instance.CreateLinkStepFrontSprite();
                    break;
                case (Direction.Up):
                    sprite = LinkSpriteFactory.Instance.CreateLinkStepBackSprite();
                    break;
                case (Direction.Left):
                    sprite = LinkSpriteFactory.Instance.CreateLinkStepLeftSprite();
                    break;
                case (Direction.Right):
                    sprite = LinkSpriteFactory.Instance.CreateLinkStepRightSprite();
                    break;
                default: break;
            }
        }
        ...
        {
            player.state = new LinkSwingSwordState(player);
        }
        public void UseItemB()
        {
            player.state = new LinkUseItemState(player);
        }
        public void PickUp()
        {
